...
2025-01-02 至 2026-08-31 的当前语料实跑结果：393 个精确 A 股 realtime Target；15 篇未进入精确 Target，其中 5 篇为 A 股休市、9 篇只提供星级区间、1 篇只提供“接近某星”的阈值信息。除文章开头证据外，正文中“目前 YYYY 年 M 月 D 日，市场在 X 星”的日期完全匹配语句也可补充精确值；日期不匹配的模板文本不会被采用。
...
1. 对 review queue 中 10 个交易日的区间/阈值证据做估值表图片复核，恢复精确小数；
